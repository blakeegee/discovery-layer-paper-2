...
```{r}
  print(jaccard)
trimmed_jaccard <- as_tibble(jaccard) %>% filter(jaccard$`Jaccard Score` < "0.89945205479452")
  print(trimmed_jaccard)
```
```{r}
write.csv(jaccard,"D:\\Rstudio projects\\tidy_string_distance\\jaccard_q7_articles_only_spring21_again_01.csv")
...
combined_titles=read.csv("D:/Rstudio projects/tidy_string_distance/jaccard_q7_nofacetsfall_all_string_cleaned_testing.csv")
...
colnames(jaccard_2) <- c("Paper title","Biblography title","Bibliography Type","Query","Search It Title","Search It Type","Jaccard Score","PaperNumMatch","QA_Match","JAccard 2","LV","JW")
...
while (b < 10) {
    ...
    new_row <-  c(matrix_combined[i,1],matrix_combined[i,2],matrix_combined[i,3],matrix_combined[i,4],matrix_combined[i,5],matrix_combined[i,6],matrix_combined[i,7],matrix_combined[i,8],matrix_combined[i,9],stringdist(tolower(matrix_combined[i,4]),tolower(matrix_combined[i,3]), method = "jaccard", q = "7"),stringdist(tolower(matrix_combined[i,2]),tolower(matrix_combined[i,5]), method ="lv"),stringdist(tolower(matrix_combined[i,2]),tolower(matrix_combined[i,5]), method = "jw"))
  b = b + 1
