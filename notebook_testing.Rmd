...
```{r}
searchit_titles=read.csv("D:/Rstudio projects/tidy_string_distance/Fall_2020/Articles_only/paperTitles-inSearchItYes-Fall2020-articlesOnly-oneObsPerRow-paper-numbers-refine-csv.csv")
