...
while (b < 4302) {
  ...
  if(matrix_source_title[i,2] == matrixsearchit_titles[b,2])
    {new_row <-  c(matrix_source_title[i,2],matrix_source_title[i,4],matrix_source_title[i,6],matrixsearchit_titles[b,2],matrixsearchit_titles[b,4],matrixsearchit_titles[b,5],stringdist(tolower(matrix_source_title[i,4]),tolower(matrixsearchit_titles[b,4]), method = "jaccard", q = "7"),stringdist(tolower(matrix_source_title[i,4]),tolower(matrixsearchit_titles[b,4]), method = "jw"),stringdist(tolower(matrix_source_title[i,4]),tolower(matrixsearchit_titles[b,4]), method = "lv"))
    b = b + 1
  jaccard[nrow(jaccard) + 1,] <- new_row
  }
  else {b = b+1}
