...
searchit_titles=read.csv("D:/Rstudio projects/tidy_string_distance/paperTitles_inSearchItYes_Fall2020_noFacets_oneObsPerRow_papernumber.csv")
...
while (n  < 100   ) {
#n should be the number of source citations to check (citations from papers, for fall 2020 citation count is 442)
#b should be the whole number of titles returned from queries to check  (titles returned from discovery layer to compare against. for fall 2020 this is 4275)
while (b < 4275) {
...
```
```{r}
write.csv(jaccard,"D:\\Rstudio projects\\tidy_string_distance\\jaccard_testing_03.csv")
